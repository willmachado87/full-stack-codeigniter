  ...
  <?php if($this->session->userdata('usuario_logado')) : ?>   
    ...
    <div class="container">
      <div>                
        ...
        <form action="/td/usuarios/editar" name="form_add" method="post">
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <select name="admin" class="form-control">
                <option value="0" <?= ($usuario->admin == '0' ? 'selected="selected"' : '' ) ?> >Não</option>
                <option value="1" <?= ($usuario->admin == '1' ? 'selected="selected"' : '' ) ?> >Sim</option>                      
              </select>
            </div>  
          </div>
